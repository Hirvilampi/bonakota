...
Expo 54 (expo-router, expo-constants, expo-status-bar)

Navigointi: @react-navigation/native, react-native-screens

UI-kirjastot: react-native-paper, react-native-dropdown-picker

Firebase 12.5.0 (Auth, Realtime Database, Firestore, Storage)

AsyncStorage (@react-native-async-storage/async-storage)

Media: expo-image-picker, expo-image-manipulator, expo-media-library, rn-fetch-blob

Other: react-native-safe-area-context, expo-constants, babel (@babel/core)
